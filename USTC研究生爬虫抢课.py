...
if __name__ == "__main__":
    # 1. 初始化session和cookies
    cookies = {
        'sduuid': 'b851401dd049b80828f13c999fec9109',
        'SESSION': 'd32c9757-fcf0-4341-b2ed-41cabe5d41bc',
        'fine_auth_token': 'eyJhbGciOiJIUzI1NiJ9..-q4HoFd8UXsGq2a38sBkGCZq-EtP3D4DHkTPPNQT0kU',
